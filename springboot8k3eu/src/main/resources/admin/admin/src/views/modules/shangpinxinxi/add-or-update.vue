<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="预计时间" prop="yujishijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.yujishijian" 
                type="date"
                :readonly="ro.yujishijian"
                placeholder="预计时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yujishijian" label="预计时间" prop="yujishijian">
              <el-input v-model="ruleForm.yujishijian" 
                placeholder="预计时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shuliang = true;
          ...
          if(o=='yujishijian'){
            this.ruleForm.yujishijian = obj[o];
	    this.ro.yujishijian = true;
            continue;
          }
	...
	this.ruleForm.shangpinxiangqing = this.ruleForm.shangpinxiangqing.replace(reg,'../../../springboot8k3eu/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
