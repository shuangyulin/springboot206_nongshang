<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="交货时间" prop="jiaohuoshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.jiaohuoshijian" 
                type="date"
                :readonly="ro.jiaohuoshijian"
                placeholder="交货时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiaohuoshijian" label="交货时间" prop="jiaohuoshijian">
              <el-input v-model="ruleForm.jiaohuoshijian" 
                placeholder="交货时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="地点" prop="didian">
          <el-input v-model="ruleForm.didian" 
              placeholder="地点" clearable  :readonly="ro.didian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="地点" prop="didian">
              <el-input v-model="ruleForm.didian" 
                placeholder="地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zongjiage = true;
          ...
          if(o=='jiaohuoshijian'){
            this.ruleForm.jiaohuoshijian = obj[o];
	    this.ro.jiaohuoshijian = true;
            continue;
          }
          if(o=='xiadanshijian'){
      ...
      this.$http({
		...
		if(this.$storage.get("role")!="管理员") {
          ...
          this.$message.error(data.msg);
            ...
            this.dingdanzhuangtaiOptions = "已交货,待交货".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
