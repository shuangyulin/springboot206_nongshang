    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="售后内容" prop="shouhouneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="售后内容"
                  v-model="ruleForm.shouhouneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shouhouneirong" label="售后内容" prop="shouhouneirong">
                    <span>{{ruleForm.shouhouneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.maijiaxingming = true;
          ...
          if(o=='shouhouneirong'){
            this.ruleForm.shouhouneirong = obj[o];
	    this.ro.shouhouneirong = true;
            continue;
          }
          if(o=='fabushijian'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shouhouxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shouhouxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
