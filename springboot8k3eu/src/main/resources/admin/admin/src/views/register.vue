  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='maijia'" class="input-group">
			   <div class="label">账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhanghao" class="input" type="text" placeholder="账号">
			   </div>
			 </div> -->
			<el-form-item label="账号" class="input" v-if="tableName=='maijia'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='maijia'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='maijia'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>

			<!-- <div v-if="tableName=='maijia'" class="input-group">
			   <div class="label">卖家姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.maijiaxingming" class="input" type="text" placeholder="卖家姓名">
			   </div>
			 </div> -->
			<el-form-item label="卖家姓名" class="input" v-if="tableName=='maijia'">
			  <el-input v-model="ruleForm.maijiaxingming" autocomplete="off" placeholder="卖家姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='maijia'" class="input-group">
			   <div class="label">邮箱</div>
			   <div class="input-container">
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='maijia'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱"  />
			</el-form-item>
			<!-- <div v-if="tableName=='maijia'" class="input-group">
			...
			<el-form-item label="电话" class="input" v-if="tableName=='maijia'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.zhanghao) && `maijia` == this.tableName){
      ...
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `maijia` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      ...
      if(`maijia` == this.tableName && this.ruleForm.dianhua&&(!this.$validate.isMobile(this.ruleForm.dianhua))){
